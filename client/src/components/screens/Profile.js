          ...
          fetch("/uploadProfile", {
            ...
            .then((resultData) => {
              ...
              localStorage.setItem(
                "user",
                JSON.stringify({ ...state, profile: resultData.profile })
              );
      ...
      >
        ...
        <div>
          ...
          >
            ...
            <h6>
              {state && state.followers && state.followers.length} Follower
            </h6>
            <h6>
              {state && state.followings && state.followings.length} Following
            </h6>
          </div>
        </div>
      </div>
